...
echo "Setting PATH variable to execute sl!"
set $PATH=$BUILD_SOURCESDIRECTORY;$PATH
echo $PATH
...
$BUILD_SOURCESDIRECTORY\\sl analyze --app Hello-ShiftLeft-App-DevOps --cpg --csharp --dotnet-framework --csharp2cpg-args "-l info" "$BUILD_SOURCESDIRECTORY\\WebGoat.Net\WebSite\WebSite.csproj"
