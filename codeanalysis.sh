...
$BUILD_SOURCESDIRECTORY\\sl analyze --app Hello-ShiftLeft-Azure --cpg --csharp --dotnet-framework --csharp2cpg-args "-l info" "$BUILD_SOURCESDIRECTORY\\WebSite\WebSite.csproj"
sleep 10
echo "Over and out."
